...
function NewPaymentUNI({ orderId }: PaymentDone) {
    ...
    useEffect(() => { localStorage.removeItem("orderUNI") }, [])
            ...
            <div className="flex flex-col items-center bg-white rounded-3xl">
                <div className="flex flex-col items-center md:mt-9">
                    ...
                    {isLoading ? <div className="flex gap-1 items-center mt-5 text-base tracking-wide leading-loose my-auto text-blue-500" >
                        {t("quote3")}  ...
                    </div> : <div className="flex gap-1 items-center mt-5 text-base tracking-wide leading-loose cursor-pointer"
                ...
                <div className="flex flex-wrap gap-4 justify-center items-center mt-6 text-base font-medium tracking-wide">
                    ...
                    <Link href={`/${language}/university`} className="flex gap-1 justify-center items-center px-20 py-3 my-auto text-white border border-solid bg-primary border-primary rounded-[64px] ">
