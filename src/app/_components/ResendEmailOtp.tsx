...
//                 <p className="text-[#141522] text-xl mt-3"> {t("resendCode")} </p>
//                 <p className="text-[#6C7278] text-sm mt-1">{t("resendCode2")}</p>
...
import { toast } from "react-toastify";
import Spinner from "./Spinner";
import SideSectionRegister from "./SideSectionRegister";
    ...
    return (
      <div className="overflow-hidden py-5 bg-zinc-100">
        <div className="flex items-center gap-5 flex-col lg:flex-row">
          <div className="flex flex-col w-full lg:w-6/12 px-0 max-md:px-3">
            <div className="flex flex-col  w-full max-md:mt-10 ">
              <div className="flex flex-col w-full justify-center items-center">
                <div className="flex flex-col w-full max-w-[500px]  lg:px-5">
                        ...
                        <div className="flex flex-col w-full max-md:max-w-full">
                          <div className="flex flex-col mt-4 w-full max-md:max-w-full">
                            ...
                            <input
                              ...
                              className={`px-4 py-3 mt-2 w-full text-sm bg-white border rounded text-zinc-600 focus:outline-none ${
                                error.email ? "border-red-500" : "border-gray"
                              }`}
                            />
                            {error.email && (
