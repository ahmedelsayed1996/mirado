...
const RequestTableCourse: React.FC<Props> = ({ headers, data }) => {
  const [openRate, setOpenRate] = useState(false);
  const [instituteId, setInstituteId] = useState<number>();
  const URlInstituteId = "institute-reviews";
  ...
  const downloadInvoices = async (id: any) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/bills/institute/${id}`,
        {
          method: "GET",
          headers: {
  ...
  return (
    <div className="overflow-auto w-full max-w-[1150px] mt-4">
          ...
          {data?.map((item: any, index: number) => {
            return (
              ...
              >
                ...
                {/* Total Price	 */}
                <td className="py-2 px-4 whitespace-nowrap">
                  {item?.total_price} {item?.institute_branch?.currency}
                </td>
                {/* Language of Study */}
                <td className="py-2 px-4 whitespace-nowrap">
                  {item?.course?.courses_translations[0].languages}
                </td>
                {/* Study Period */}
                <td className="py-2 px-4 whitespace-nowrap">
                  {item?.number_of_weeks} Weeks
                ...
                <td className="py-2 px-4 whitespace-nowrap">
                  {item.rating > 0 ? (
                    ...
                    <button
                      ...
                      onClick={() => {
                        setInstituteId(item.institute_branch_id);
                        setOpenRate(true);
                      }}
                    >
                      <svg
                    ...
                    >
                      <div className="relative flex flex-col items-center group">
                        ...
                        <div className="absolute bottom-0  flex-col items-center hidden mb-5 group-hover:flex">
                          ...
                          <div className="w-3 h-3 -mt-2 rotate-45 bg-gray"></div>
                        </div>
                      </div>
                    </div>
                    {/* <Link href={`/${language}/language-schools/${item.institute_branch?.institute?.id}/${item.institute_branch?.id}/${item.course?.id}`} className="flex shrink-0 self-stretch my-auto p-1 bg-white rounded border border-solid border-zinc-100">
                                            <div className="relative flex flex-col items-center group">
                                                <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M14.1667 6.10044C12.6267 3.68044 10.3734 2.28711 8.00004 2.28711C6.81337 2.28711 5.66004 2.63378 4.60671 3.28044C3.55337 3.93378 2.60671 4.88711 1.83337 6.10044C1.16671 7.14711 1.16671 8.84711 1.83337 9.89378C3.37337 12.3204 5.62671 13.7071 8.00004 13.7071C9.18671 13.7071 10.34 13.3604 11.3934 12.7138C12.4467 12.0604 13.3934 11.1071 14.1667 9.89378C14.8334 8.85378 14.8334 7.14711 14.1667 6.10044ZM8.00004 10.6938C6.50671 10.6938 5.30671 9.48711 5.30671 8.00044C5.30671 6.51378 6.50671 5.30711 8.00004 5.30711C9.49337 5.30711 10.6934 6.51378 10.6934 8.00044C10.6934 9.48711 9.49337 10.6938 8.00004 10.6938Z" fill="#F89A21" />
                                                    <path d="M7.99998 6.09375C6.95331 6.09375 6.09998 6.94708 6.09998 8.00042C6.09998 9.04708 6.95331 9.90042 7.99998 9.90042C9.04664 9.90042 9.90664 9.04708 9.90664 8.00042C9.90664 6.95375 9.04664 6.09375 7.99998 6.09375Z" fill="#F89A21" />
                                                </svg>
                                                <div className="absolute bottom-0  flex-col items-center hidden mb-5 group-hover:flex">
                                                    <span className="relative rounded-md z-10 p-2 text-xs leading-none text-black whitespace-no-wrap bg-white shadow-2xl flex items-center gap-1">Program Details
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M17.25 9C17.25 13.5563 13.5563 17.25 9 17.25C4.44365 17.25 0.75 13.5563 0.75 9C0.75 4.44365 4.44365 0.75 9 0.75C13.5563 0.75 17.25 4.44365 17.25 9ZM8.11268 6.20681C8.41808 6.02732 8.77715 5.96171 9.12629 6.0216C9.47543 6.08148 9.79211 6.263 10.0202 6.53401C10.2484 6.80501 10.3732 7.148 10.3727 7.50224L10.3727 7.50336C10.3727 7.85521 10.0989 8.22202 9.58168 8.56682C9.3459 8.724 9.10479 8.8451 8.91966 8.92737C8.82817 8.96804 8.75296 8.99807 8.70239 9.01734C8.67716 9.02695 8.65825 9.03381 8.64672 9.03791L8.63514 9.04198C8.24244 9.17311 8.03025 9.5977 8.16119 9.99053C8.29218 10.3835 8.71692 10.5959 9.10988 10.4649L8.8727 9.75336C9.10988 10.4649 9.11082 10.4646 9.11082 10.4646L9.11196 10.4642L9.11489 10.4632L9.12318 10.4604L9.14923 10.4512C9.17065 10.4436 9.20008 10.4329 9.23638 10.4191C9.30886 10.3915 9.40943 10.3512 9.52887 10.2981C9.76562 10.1929 10.087 10.0327 10.4137 9.8149C11.0214 9.40978 11.8724 8.65181 11.8727 7.50404C11.8737 6.79572 11.6239 6.1099 11.1678 5.568C10.7115 5.026 10.0782 4.66296 9.37988 4.54319C8.6816 4.42341 7.96346 4.55463 7.35266 4.91361C6.74186 5.27258 6.27781 5.83614 6.0427 6.50448C5.90525 6.89522 6.11058 7.3234 6.50132 7.46086C6.89206 7.59831 7.32025 7.39298 7.45771 7.00224C7.57526 6.66807 7.80728 6.38629 8.11268 6.20681ZM8.9327 12.0034C8.51849 12.0034 8.1827 12.3391 8.1827 12.7534C8.1827 13.1676 8.51849 13.5034 8.9327 13.5034H8.9402C9.35442 13.5034 9.6902 13.1676 9.6902 12.7534C9.6902 12.3391 9.35442 12.0034 8.9402 12.0034H8.9327Z" fill="#384250" />
                                                        </svg>
                                                    </span>
                                                    <div className="w-3 h-3 -mt-2 rotate-45 bg-gray"></div>
                                                </div>
      ...
      {/* Display PopUpRating */}
      {openRate && instituteId !== undefined && (
        <PopUpRating
          closeRate={() => setOpenRate(false)}
          ID={instituteId}
          URL={URlInstituteId}
          TheKey={"institute_branch_id"}
        />
      )}
    </div>
  );
...
export default RequestTableCourse;
